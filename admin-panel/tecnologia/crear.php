...
if ($_POST) {
    ...
    $stmt = $pdo->prepare("INSERT INTO tecnologia (nombre, descripcion, precio, imagen_url) VALUES (:nombre, :descripcion, :precio, :imagen)");
$stmt->execute([
    'nombre' => $_POST['nombre'],
...
<head>
    ...
    <title>Agregar Producto de Tecnología</title>
    <style>
        :root {
...
<body>
    <div class="container">
        <div class="header">
            <h2><i class="fas fa-laptop"></i> Agregar Producto de Tecnología</h2>
