...
$id = $_GET['id'];
$res = $conn->query("SELECT * FROM papeleria WHERE id=$id");
$papeleria = $res->fetch_assoc();
...
if ($_POST) {
    ...
    $stmt = $conn->prepare("UPDATE papeleria SET nombre=?, descripcion=?, precio=?, imagen_url=? WHERE id=?");
