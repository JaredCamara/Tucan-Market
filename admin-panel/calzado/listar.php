...
<body>
    <div class="container">
        <div class="header">
            <h2><i class="fas fa-shoe-prints"></i> Lista de Calzado</h2>
    ...
    foreach ($ropa as $row) {
            ...
            ?>
                <div class="no-products">
                    <i class="fas fa-shoe-prints" style="font-size: 3rem; color: #ccc; margin-bottom: 15px;"></i>
                    <h3>No hay productos de calzado registrados</h3>
