...
if ($_POST) {
    ...
    $stmt = $pdo->prepare("INSERT INTO calzado (nombre, descripcion, precio, imagen_url) VALUES (:nombre, :descripcion, :precio, :imagen)");
$stmt->execute([
    'nombre' => $_POST['nombre'],
...
<body>
    <div class="container">
        <div class="header">
            <h2><i class="fas fa-shoe-prints"></i> Agregar Calzado</h2>
        ...
        <form method="POST" enctype="multipart/form-data" id="productForm">
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn">
                    <i class="fas fa-save"></i> Guardar Calzado
                </button>
            </div>
        </form>
    </div>
