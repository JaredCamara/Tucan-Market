...
<head>
    ...
    <title>Editar Prenda de Ropa</title>
    <style>
        :root {
...
<body>
    <div class="container">
        <div class="header">
            <h2><i class="fas fa-tshirt"></i> Editar Prenda de Ropa</h2>
        ...
        <form method="POST" enctype="multipart/form-data" id="productForm">
            <div class="form-group">
                ...
                <input type="text" id="nombre" name="nombre" value="<?= htmlspecialchars($ropa['nombre']) ?>" required>
            </div>
            
            <div class="form-group">
                <label for="descripcion">Descripción</label>
                <textarea id="descripcion" name="descripcion"><?= htmlspecialchars($ropa['descripcion']) ?></textarea>
            </div>
            
            <div class="form-group">
                <label for="precio" class="required-field">Precio</label>
                <input type="number" id="precio" name="precio" step="0.01" min="0" value="<?= htmlspecialchars($ropa['precio']) ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="current-image">
                    <p>Imagen actual:</p>
                    <img src="<?= htmlspecialchars($ropa['imagen_url']) ?>" class="image-preview" onerror="this.src='https://via.placeholder.com/200?text=Imagen+no+disponible'">
                </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn">
                    <i class="fas fa-save"></i> Actualizar Prenda
                </button>
            </div>
        </form>
    </div>
